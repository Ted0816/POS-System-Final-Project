...
public class POSSystem1 extends javax.swing.JFrame {
   ...
   double Ted = 0.0;
    ...
    private void BucketComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BucketComboActionPerformed
  int i = Integer.valueOf(T5.getText());
        ...
        cal();        cal();    }//GEN-LAST:event_BucketComboActionPerformed

    private void ChickenFilletBurgerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChickenFilletBurgerActionPerformed
  int i = Integer.valueOf(T6.getText());
        ...
        cal();    }//GEN-LAST:event_ChickenFilletBurgerActionPerformed
